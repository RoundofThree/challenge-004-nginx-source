...
## Option 1: I just want to build and run the demo on Morello using demo.py
...
## Option 2: I want to build, run, and debug individual CPVs using test.py
...
If you want to build with subobject bounds, add `-Xclang -cheri-bounds=subobject-safe`, for example:
